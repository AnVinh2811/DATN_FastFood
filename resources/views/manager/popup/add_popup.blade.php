									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{URL::to('/store')}}" method="post" enctype="multipart/form-data">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text"  name="popup_name" class="form-control" required="required" placeholder="Tên quảng cáo">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 text-center">
												<span class="btn btn-default btn-file">
					                             <img src="{!! asset('web/images/download.png')!!}" id="imgPre" class="img-thumbnail cover" width="300px"/> <input type="file" name="hinh_popup" id="ful" required="required" >
					                             </span>
